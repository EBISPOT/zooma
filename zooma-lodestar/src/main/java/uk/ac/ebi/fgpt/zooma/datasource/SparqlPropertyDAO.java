...
public class SparqlPropertyDAO implements PropertyDAO {
    ...
    @Override public void create(Property property) throws ResourceAlreadyExistsException {
        ...
        if (read(property.getURI()) != null) {
            throw new ResourceAlreadyExistsException("Can't create new property entity with " + property.getURI() + ", URI already exists");
        }
    ...
    @Override public void update(Property property) throws NoSuchResourceException {
        ...
        if (read(property.getURI()) == null) {
            throw new NoSuchResourceException("Can't update property entity with URI " + property.getURI() + " no such property entity exists");
        }
    ...
    @Override public void delete(Property property) throws NoSuchResourceException {
        if (read(property.getURI()) == null) {
            throw new NoSuchResourceException("Can't delete property entity with URI " + property.getURI() + " no such property entity exists");
        }
