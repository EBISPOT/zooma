...
public class SparqlStudyDAO implements StudyDAO {
    ...
    @Override public void create(Study study) throws ResourceAlreadyExistsException {
        ...
        if (read(study.getURI()) != null) {
            throw new ResourceAlreadyExistsException("Can't create new study entity with " + study.getURI() + ", URI already exists");
        }
    ...
    @Override public void update(Study study) throws NoSuchResourceException {
        ...
        if (read(study.getURI()) == null) {
            throw new NoSuchResourceException("Can't update study entity with URI " + study.getURI() + " no such study entity exists");
        }
    ...
    @Override public void delete(Study study) throws NoSuchResourceException {
        if (read(study.getURI()) == null) {
            throw new NoSuchResourceException("Can't delete study entity with URI " + study.getURI() + " no such study entity exists");
        }
