    ...
    public Annotation createAnnotation(String studyAccession,
        ...
        if (s != null) {
            ...
            if (bioentityURI != null) {
                ...
                be = getAnnotationLoadingSession().getOrCreateBiologicalEntity(bioentityName, bioentityURI, new ArrayList<>());
            }
            else {
                if (bioentityName != null) {
                    be = getAnnotationLoadingSession().getOrCreateBiologicalEntity(bioentityName, new ArrayList<>());
                }
                else {
                    be = null;
                }
