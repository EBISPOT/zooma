...
import uk.ac.ebi.spot.zooma.service.CSVLoadingSession;
import uk.ac.ebi.spot.zooma.service.DefaultAnnotationFactory;
 ...
 * Creates a {@link CSVLoader} bean and its corresponding {@link AnnotationLoadingSession} and
 * {@link AnnotationFactory} beans, for each loader defined in the application.properties file
 *
