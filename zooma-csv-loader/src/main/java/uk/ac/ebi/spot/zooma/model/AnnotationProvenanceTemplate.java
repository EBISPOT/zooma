...
/**
 * A templating temp for {@link AnnotationProvenance} objects.  This temp declares
...
public interface AnnotationProvenanceTemplate extends AnnotationProvenance {
    ...
    /**
     * Returns a completed, "concrete" instance of an {@link AnnotationProvenance} object,
