...
/**
 * A builder for an {@link MongoAnnotationProvenance} instance.
 * Uses a {@link AnnotationProvenanceTemplate} to populate the annotation source, generator and date
 *
 * @author Tony Burdett
 * @date 17/08/15
 */
public abstract class AnnotationProvenanceBuilder {
    ...
    private static class SimpleAnnotationProvenanceTemplate implements AnnotationProvenanceTemplate {
        ...
        public MongoAnnotationProvenance.Evidence getEvidence() {
            return evidence;
        }
        ...
        public MongoAnnotationProvenance.Accuracy getAccuracy() {
            return accuracy;
        }
        ...
        @Override
        public AnnotationProvenanceTemplate evidenceIs(Evidence evidence) {
        ...
        @Override
        public MongoAnnotationProvenance build() {
            if (source == null) {
            ...
            return new MongoAnnotationProvenance((DatabaseAnnotationSource) source,
                                                  evidence,
                                                  accuracy,
                                                  generator,
                                                  annotator,
