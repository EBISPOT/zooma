...
function resetLodestar() {
    loadestarQueryService = undefined
    loadstarExploreService = undefined
    lodestarResultsPerPage = undefined
    lodestarIslogging = undefined
    lodestarDefaultQuery = undefined
    lodestarVoidQuery = undefined
    lodestarRdfsInference = undefined
    lodestarDefaultResourceImg = undefined

    loadstarNamespaces = {}
    tableid = "loadstar-results-table"

    lodestarNextUrl = undefined
    loadstarPrevUrl = undefined

    sparqlQueryTextArea = undefined

    lodestarDiv = $("<div id='lodestar-main' class='ui-widget ui-corner-all'></div>");
    contentsDiv = $("<div id='lodestar-contents' class='ui-widget ui-corner-all'></div>");
    errorDiv = $("<div id='error-div' class='ui-state-error' style='display: none;'/>");
    errorDiv.append($("<p class='alert'>Error: </p>").append($("<span id='error-text'></span>")));

    appdetails = $("<div id='lodestar-description' class='ui-widget ui-corner-all'/>")
        .append($("<p></p>")
    ...
    logginDiv = $('<div style="display: none;" id="lode-log"/>').
