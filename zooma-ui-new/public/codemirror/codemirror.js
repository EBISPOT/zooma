...
window.CodeMirror = (function() {
    ...
    function patchDisplay(cm, from, to, intact, updateNumbersFrom) {
        ...
        cm.doc.iter(from, to, function(line) {
            ...
            if (lineIsHidden(cm.doc, line)) {
                ...
                if (line.widgets) {
                    for (var j = 0, search = cur, reuse; search && j < 20;
    ...
    function paddingLeft(display) {
        var e = removeChildrenAndAdd(display.measure,
    ...
    function onScrollWheel(cm, e) {
        ...
        if (dx && !gecko && !opera && wheelPixelsPerUnit != null) {
            ...
            setScrollLeft(cm,
                          Math.max(0,
                                   Math.min(scroll.scrollLeft + dx * wheelPixelsPerUnit,
    ...
    function scrollCursorIntoView(cm) {
        ...
        else if (coords.bottom + pTop + box.top >
    ...
    function scrollPosIntoView(cm, pos, margin) {
        ...
        for (; ;) {
            ...
            var scrollPos = calculateScrollPos(cm, coords.left, coords.top - margin, coords.left,
    ...
    function calculateScrollPos(cm, x1, y1, x2, y2) {
        ...
        var screen = display.scroller.clientHeight -
        ...
        column: function() {
            if (this.lastColumnPos < this.start) {
                this.lastColumnValue =
                        countColumn(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue);
    ...
    Doc.prototype = createObj(BranchChunk.prototype, {
        ...
        replaceSelection: function(code, collapse, origin) {
            makeChange(this, {from: this.sel.from, to: this.sel.to, text: splitLines(code), origin: origin},
                       collapse || "around");
        },
    ...
    if (gecko) // Only for "$'"
    {
        ...
        spanAffectsWrapping = function(str, i) {
            if (i > 1 && str.charCodeAt(i - 1) == 45 && /\w/.test(str.charAt(i - 2)) &&
                    /[^\-?\.]/.test(str.charAt(i))) {
                return true;
            }
