...
/**
 * Created by dwelter on 10/06/14.
 */
public class ChemblCLOAnnotationDAO implements AnnotationDAO {
    ...
    public ChemblCLOAnnotationDAO() {
        this(new ChemblAnnotationFactory(new ChemblLoadingSession()));
    }

    public ChemblCLOAnnotationDAO(AnnotationFactory annotationFactory) {
        this(new JDBCConventionBasedAnnotationMapper(annotationFactory));
    }

    public ChemblCLOAnnotationDAO(JDBCConventionBasedAnnotationMapper annotationMapper) {
