...
/**
 * An Annotation DAO that is capable of reading sample annotations from the ArrayExpress database.
 * <p/>
 ...
 * @date 14/06/12
 */
public class ArrayExpressSampleAnnotationDAO implements AnnotationDAO {
