...
//            "select distinct s.ACC as STUDY, m.NAME as BIOENTITY, p.NAME as PROPERTY_TYPE, " +
//                    "pv.NAME as PROPERTY_VALUE, null as SEMANTIC_TAG " +
//                    "from STUDY s " +
...
//                    "and pv.NAME is not null ";
    // revised query to ensure we only extract annotations when the
    // sample doesn't contain multiple characterstics of the same type
    public static final String ANNOTATIONS_SELECT =
