...
public interface ZoomaDAO<I extends Identifiable> {
     ...
     * exists, this operation will fail with an {@link uk.ac.ebi.fgpt.zooma.exception.NoSuchResourceException}.
     *
     * @param object the identifiable in zooma to update (identity is assumed by matching URI)
     * @throws uk.ac.ebi.fgpt.zooma.exception.NoSuchResourceException
