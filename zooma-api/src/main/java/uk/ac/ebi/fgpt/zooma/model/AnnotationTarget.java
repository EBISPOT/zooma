...
/**
 *
 * Represents any type of entity (which may be a biological sample, an assay, or something else) which can be
 * named and identified, and is the target of some Zooma annotation
 *
 * @author Simon Jupp
 * @date 07/10/2013
