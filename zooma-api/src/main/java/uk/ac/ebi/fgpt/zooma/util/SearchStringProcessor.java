 ...
 * @author Tony Burdett
 * @date 01/08/13
 * @see uk.ac.ebi.fgpt.zooma.service.AnnotationSearchService
 * @see uk.ac.ebi.fgpt.zooma.service.AnnotationSummarySearchService
 * @see uk.ac.ebi.fgpt.zooma.service.PropertySearchService
 */
