 ...
 * biological entity based operations will use the {@link BiologicalEntityService} to do direct retrieval operations,
...
public interface BiologicalEntitySearchService {
     ...
     * semantic tags.
     * <p/>
     * This form returns a map of matching biological entities linked to a metric that describes the quality of the
     * match.  You may need to sort results based on their score to determine the best match order
     *
     * @param semanticTagShortnames the set of semantic tags that all results should annotate to
     * @return a collection of studies that annotate to all of the supplied entities
     */
    Map<BiologicalEntity, Float> searchAndScoreBySemanticTags(String... semanticTagShortnames);
     ...
     * @return a collection of studies that annotate to all of the supplied entities
     */
    Map<BiologicalEntity, Float> searchAndScoreBySemanticTags(URI... semanticTags);
     ...
     * @return a collection of studies that annotate to all of the supplied entities
     */
    Map<BiologicalEntity, Float> searchAndScoreBySemanticTags(boolean useInference, String... semanticTagShortnames);
     ...
     * @return a collection of studies that annotate to all of the supplied entities
     */
    Map<BiologicalEntity, Float> searchAndScoreBySemanticTags(boolean useInference, URI... semanticTags);
}
