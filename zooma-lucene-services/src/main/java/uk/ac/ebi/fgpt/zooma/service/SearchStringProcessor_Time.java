...
public class SearchStringProcessor_Time implements SearchStringProcessor {
  ...
  public boolean canProcess(String searchString, String searchStringType) {
    if (searchStringType != null && !searchStringType.isEmpty()) {
      ...
      if (searchStringType.contentEquals("time") || searchStringType.contentEquals("time unit") ||
          searchStringType.contentEquals("time_unit") || searchStringType.contentEquals("timeunit") ||
          searchStringType.contentEquals("age") || searchStringType.contentEquals("derived time unit") ||
          searchStringType.contentEquals("time derived unit") || searchStringType.contentEquals("period")) {
        return true;
      }
    }
    return false;
