 ...
 */
public interface AnnotationPredictionSearch {

    List<AnnotationPrediction> search(String propertyValuePattern);

    List<AnnotationPrediction> search(String propertyValuePattern, List<String> sources);

    List<AnnotationPrediction> search(String propertyType, String propertyValuePattern);

    List<AnnotationPrediction> search(String propertyType, String propertyValuePattern, List<String> sources);
